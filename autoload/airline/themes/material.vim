...
function! airline#themes#material#refresh()
  ...
  let s:N1 = airline#themes#get_highlight2(['CursorLine', 'bg'], ['PreProc', 'fg'], 'bold')
  ...
  let s:I1 = airline#themes#get_highlight2(['CursorLine', 'bg'], ['Special', 'fg'], 'bold')
  ...
  let s:V1 = airline#themes#get_highlight2(['CursorLine', 'bg'], ['Function', 'fg'], 'bold')
