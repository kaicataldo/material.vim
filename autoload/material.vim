let s:overrides = get(g:, "material_color_overrides", {})

let s:bg_color = { "gui": "#263238", "cterm": "235", "cterm16": "0" }
if exists("g:material_theme_style")
  if g:material_theme_style == "palenight"
    let s:bg_color = { "gui": "#292D3E", "cterm": "235", "cterm16": "0" }
  elseif g:material_theme_style == "dark"
    let s:bg_color = { "gui": "#212121", "cterm": "235", "cterm16": "0" }
  end
endif
...
let s:colors = {
      ...
      \ "black": get(s:overrides, "black", s:bg_color),
