...
if has('nvim')
  ...
  if has('nvim-0.8')
    ...
    call s:SetHighlight('@conditional', s:cyan, '', 'italic')
    call s:SetHighlight('@constructor', s:yellow, '', '')
    call s:SetHighlight('@constant.builtin', s:cyan, '', '')
    call s:SetHighlight('@exception', s:cyan, '', 'italic')
    call s:SetHighlight('@field', s:white, '', '')
    call s:SetHighlight('@function', s:blue, '', '')
    ...
    call s:SetHighlight('@method', s:blue, '', '')
    call s:SetHighlight('@operator', s:cyan, '', '')
    ...
    call s:SetHighlight('@repeat', s:cyan, '', 'italic')
