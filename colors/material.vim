...
function! s:h(group, style)
  if g:material_terminal_italics == 0
...
function! material#set_highlight(group, style)
...
let s:colors = material#GetColors()
...
call s:h("Todo", { "fg": s:purple, "gui": "italic", "cterm": "italic" }) " anything that needs extra attention; mostly the keywords TODO FIXME and XXX
...
call s:h("htmlArg", { "fg": s:yellow, "gui": "italic", "cterm": "italic" })
...
" XML
call s:h("xmlAttrib", { "fg": s:yellow, "gui": "italic", "cterm": "italic" })
