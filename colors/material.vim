...
let s:invisibles = { 'gui': '#65738e', 'cterm': '066' }
let s:comments = { 'gui': '#546e7a', 'cterm': '060' }
let s:caret = { 'gui': '#ffcc00', 'cterm': '220' }
let s:selection = { 'gui': '#2c3b41', 'cterm': '0' }
let s:guides = { 'gui': '#37474f', 'cterm': '017' }
let s:line_numbers = { 'gui': '#37474f', 'cterm': '017' }
let s:line_highlight = { 'gui': '#1a2327', 'cterm': '0' }
...
if g:material_theme_style == 'palenight'
  ...
  let s:invisibles = { 'gui': '#4e5579', 'cterm': '060' }
  let s:comments = { 'gui': '#676e95', 'cterm': '18' }
  let s:selection = { 'gui': '#343b51', 'cterm': '017' }
  let s:guides = { 'gui': '#4e5579', 'cterm': '060' }
...
elseif g:material_theme_style == 'darker'
  ...
  let s:fg = { 'gui': '#eeffff', 'cterm': '231' }
  let s:invisibles = { 'gui': '#65737e', 'cterm': '066' }
  let s:comments = { 'gui': '#545454', 'cterm': '059' }
  let s:selection = { 'gui': '#2c2c2c', 'cterm': '0' }
...
elseif g:material_theme_style == 'ocean'
  ...
  let s:comments = { 'gui': '#464b5d', 'cterm': '023' }
  let s:selection = { 'gui': '#1f2233', 'cterm': '0' }
  let s:guides = { 'gui': '#3b3f51', 'cterm': '017' }
  let s:line_numbers = { 'gui': '#3b3f51', 'cterm': '017' }
...
elseif g:material_theme_style == 'lighter'
  ...
  let s:selection = { 'gui': '#ebf4f3', 'cterm': '231' }
  ...
  let s:cyan = { 'gui': '#39adb5', 'cterm': '037' }
  let s:blue = { 'gui': '#6182b8', 'cterm': '067' }
  let s:paleblue = { 'gui': '#8796b0', 'cterm': '103' }
  let s:purple = { 'gui': '#7c4dff', 'cterm': '099' }
  let s:brown = { 'gui': '#c17e70', 'cterm': '137' }
  let s:pink = { 'gui': '#ff5370', 'cterm': '203' }
  let s:violet = { 'gui': '#945eb8', 'cterm': '097' }
endif
