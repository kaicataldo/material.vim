...
if has('nvim')
  ...
  if has('nvim-0.8')
    ...
    call s:SetHighlight('@attribute', s:yellow, '', '')
    call s:SetHighlight('@attribute.builtin', s:yellow, '', '')
    call s:SetHighlight('@boolean', s:orange, '', '')
    call s:SetHighlight('@character', s:green, '', '')
    call s:SetHighlight('@character.special', s:purple, '', '')
    call s:SetHighlight('@comment', s:comments, '', 'italic')
    call s:SetHighlight('@comment.documentation', s:comments, '', 'italic')
    call s:SetHighlight('@comment.error', s:pink, '', '')
    call s:SetHighlight('@comment.hint', s:cyan, '', '')
    call s:SetHighlight('@comment.info', s:cyan, '', '')
    call s:SetHighlight('@comment.todo', s:orange, '', '')
    call s:SetHighlight('@comment.warning', s:yellow, '', '')
    call s:SetHighlight('@constant', s:orange, '', '')
    call s:SetHighlight('@constant.builtin', s:orange, '', '')
    call s:SetHighlight('@constant.macro', s:purple, '', '')
    call s:SetHighlight('@constructor', s:yellow, '', '')
    call s:SetHighlight('@diff.delta', s:yellow, '', '')
    call s:SetHighlight('@diff.minus', s:red, '', '')
    call s:SetHighlight('@diff.plus', s:green, '', '')
    call s:SetHighlight('@function', s:blue, '', '')
    call s:SetHighlight('@function.builtin', s:blue, '', '')
    call s:SetHighlight('@function.macro', s:purple, '', '')
    call s:SetHighlight('@function.method', s:blue, '', '')
    call s:SetHighlight('@keyword', s:purple, '', '')
    call s:SetHighlight('@keyword.conditional', s:cyan, '', 'italic')
    call s:SetHighlight('@keyword.directive', s:purple, '', '')
    call s:SetHighlight('@keyword.directive.define', s:purple, '', '')
    call s:SetHighlight('@keyword.exception', s:cyan, '', 'italic')
    call s:SetHighlight('@keyword.function', s:purple, '', '')
    call s:SetHighlight('@keyword.import', s:cyan, '', 'italic')
    call s:SetHighlight('@keyword.operator', s:cyan, '', 'italic')
    call s:SetHighlight('@keyword.repeat', s:cyan, '', 'italic')
    call s:SetHighlight('@keyword.return', s:cyan, '', 'italic')
    call s:SetHighlight('@label', s:purple, '', '')
    call s:SetHighlight('@markup.heading', s:yellow, '', '')
    call s:SetHighlight('@markup.heading.1', s:yellow, '', '')
    call s:SetHighlight('@markup.heading.2', s:yellow, '', '')
    call s:SetHighlight('@markup.heading.3', s:yellow, '', '')
    call s:SetHighlight('@markup.heading.4', s:yellow, '', '')
    call s:SetHighlight('@markup.heading.5', s:yellow, '', '')
    call s:SetHighlight('@markup.heading.6', s:yellow, '', '')
    call s:SetHighlight('@markup.italic', s:pink, '', 'italic')
    call s:SetHighlight('@markup.link', s:pink, '', '')
    call s:SetHighlight('@markup.list', s:cyan, '', '')
    call s:SetHighlight('@markup.list.checked', s:cyan, '', '')
    call s:SetHighlight('@markup.list.unchecked', s:cyan, '', '')
    call s:SetHighlight('@markup.math', s:cyan, '', '')
    call s:SetHighlight('@markup.quote', s:comments, '', '')
    call s:SetHighlight('@markup.raw', s:paleblue, '', '')
    call s:SetHighlight('@markup.strikethrough', s:pink, '', 'strikethrough')
    call s:SetHighlight('@markup.strong', s:pink, '', 'bold')
    call s:SetHighlight('@markup.underline', s:pink, '', 'underline')
    call s:SetHighlight('@module', s:red, '', '')
    call s:SetHighlight('@number', s:orange, '', '')
    call s:SetHighlight('@number.float', s:orange, '', '')
    call s:SetHighlight('@operator', s:cyan, '', '')
    ...
    call s:SetHighlight('@string', s:green, '', '')
    call s:SetHighlight('@string.documentation', s:comments, '', '')
    call s:SetHighlight('@string.escape', s:purple, '', '')
    call s:SetHighlight('@string.regexp', s:purple, '', '')
    call s:SetHighlight('@string.special', s:blue, '', '')
    call s:SetHighlight('@tag', s:pink, '', '')
    call s:SetHighlight('@tag.attribute', s:purple, '', '')
    call s:SetHighlight('@tag.delimiter', s:cyan, '', '')
    call s:SetHighlight('@type', s:yellow, '', '')
    call s:SetHighlight('@type.builtin', s:yellow, '', '')
    call s:SetHighlight('@type.definition', s:yellow, '', '')
    call s:SetHighlight('@variable', s:fg, '', '')
    call s:SetHighlight('@variable.builtin', s:fg, '', '')
    call s:SetHighlight('@variable.member', s:fg, '', '')
    call s:SetHighlight('@variable.parameter', s:fg, '', '')
  else
    " Tree-sitter (Neovim v0.7)
    " Can be removed when support for Neovim v0.7 is dropped.
